  ...
  return (
    <div className="w-full h-16 border-b sticky z-10 top-0 bg-white">
      <div className="h-full px-3 max-w-screen-xl m-auto flex items-center justify-between">
        ...
        <Link to="/"><p className="font-inter sm:text-[24px] text-[16px] font-bold">Exclusive</p></Link>
        </div>

        {/* navbar  */}
        <nav className="hidden lg:flex gap-[35px] ml-[5rem]">
        ...
        <div className=" w-[347px] h-[38px] flex items-center justify-between">
          <div className="flex items-center sm:w-[223px] w-full h-full bg-[#dddcdc] justify-between rounded-sm py-[7px] px-[8px]">
            <input
              type="text"
              className="w-full bg-transparent h-full outline-none font-poppins text-[10px] sm:text-[14px] placeholder-black font-light"
